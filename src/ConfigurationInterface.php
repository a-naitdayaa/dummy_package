...
interface ConfigurationInterface
{
     ...
     *
     * @return mixed
     * @throws UnknownOptionException if $requested key does not exist or is malformed
     * @throws ValidationException if the shcema failed to validate the given input
     */
     ...
     * @psalm-param non-empty-string $key
     *
     * @return bool wether the given option exists
     *
